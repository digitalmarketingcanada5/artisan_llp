...
const AboutCard: React.FC<AboutCardProps> = ({ name, description, imgSrc, imagePosition }) => (
  <div className="relative rounded-2xl border border-zinc-800 p-6 mb-8 bg-black/20 backdrop-blur-sm hover:border-purple-400/50 transition-all duration-300">
    <div className={`flex flex-col lg:flex-row gap-6 items-start ${imagePosition === 'right' ? 'lg:flex-row-reverse' : ''}`}>
