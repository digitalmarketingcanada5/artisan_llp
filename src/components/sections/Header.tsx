  ...
  <div className="flex max-w-full fixed top-0 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] dark:bg-black/95 bg-white/[0.96] backdrop-blur-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] px-6 py-3 items-center justify-center space-x-8">
    ...
    <div className="flex items-center space-x-8">
      <a className="relative group flex items-center space-x-2 text-neutral-600 dark:text-neutral-300 hover:text-purple-500 dark:hover:text-purple-400 transition-all duration-300 font-medium" href="#services">
        ...
        <span className="hidden sm:block text-sm tracking-wide">Services</span>
        <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-500 group-hover:w-full transition-all duration-300"></div>
      </a>
      
      <a className="relative group flex items-center space-x-2 text-neutral-600 dark:text-neutral-300 hover:text-purple-500 dark:hover:text-purple-400 transition-all duration-300 font-medium" href="#about">
        <span className="block sm:hidden group-hover:scale-110 transition-transform duration-200"><ManIcon /></span>
        <span className="hidden sm:block text-sm tracking-wide">Our Team</span>
        <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-500 group-hover:w-full transition-all duration-300"></div>
      </a>
      
      <a className="relative group flex items-center space-x-2 text-neutral-600 dark:text-neutral-300 hover:text-purple-500 dark:hover:text-purple-400 transition-all duration-300 font-medium" href="#testimonials">
        <span className="block sm:hidden group-hover:scale-110 transition-transform duration-200"><StarIcon /></span>
        <span className="hidden sm:block text-sm tracking-wide">Reviews</span>
        <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-500 group-hover:w-full transition-all duration-300"></div>
      </a>
      
      <a className="relative group flex items-center space-x-2 text-neutral-600 dark:text-neutral-300 hover:text-purple-500 dark:hover:text-purple-400 transition-all duration-300 font-medium" href="#touch">
        <span className="block sm:hidden group-hover:scale-110 transition-transform duration-200"><PhoneIcon /></span>
        <span className="hidden sm:block text-sm tracking-wide">Contact</span>
        <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-500 group-hover:w-full transition-all duration-300"></div>
      </a>
    </div>
